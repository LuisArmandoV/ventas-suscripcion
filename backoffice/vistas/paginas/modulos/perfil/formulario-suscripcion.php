<div class="col-12 col-md-8">
	...
	<div class="card card-primary card-outline">
		...
		<div class="card-body">
			...
			<p class="card-text">Al activar su membresía anual ingresa en nuestro programa de afiliados, el cual podrá generar ingresos extras de forma consecutiva gracias a la red multinivel que puede hacer con nosotros, más información ingrese a la página <a href="plan-compensacion">Plan de compensanción.</a></p>
			...
			<div class="form-group">
				...
				<div>
					...
					<input type="text" class="form-control" id="inputEmail" value="info@compraganando.com" readonly>
			...
			<div class="form-group">
				...
				<div>
					...
					<input type="text" class="form-control" id="inputPatrocinador" value="compra-ganando" readonly>
			...
			<div class="form-group">
				...
				<div class="input-group"> 
					<div class="input-group-prepend">
						<span class="p-2 bg-info rounded-left">http://compraganando.com/</span>
					</div>
					<input type="text" class="form-control" id="inputAfiliado" value="compra-ganando" readonly>
				</div>
			...
			<div class="form-group">
				...
				<div>
					<select class="form-control select2 py-4" id="inputDepartamento">
			...
			<div class="form-group">
				...
				<label for="inputMunicipio" class="control-label">Municipio</label>

				<div>
					<select class="form-control select2 py-4" id="inputMunicipio">
			...
			<div class="form-group">
				...
				<select class="form-control" id="tipoRed">
					...
					<option value="matriz">Red Matriz 5x6</option>
