		...
		<div class="d-flex flex-column-reverse flex-lg-row">			
			...
			<div class="pt-lg-5 px-lg-5">
				...
				<div class="p-5 visitanos">
					...
					<p>Estamos aquí para ayudarte a crecer. Si tienes dudas, comentarios o necesitas asesoría, no dudes en escribirnos. ¡Tu éxito es nuestra prioridad!</p>

					<p>
					Rionegro.<br>
					Antioquia<br>
					WhatsApp 323 4346255
					</p>
			
					<p class="pb-lg-5">Email: admin@compraganando.com<br>
					Tel: 323 4346255</p>
