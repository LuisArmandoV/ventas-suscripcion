...
<div class="container-fluid vistaVideo p-0">
	...
	<div class="container">
		...
		<h1 class="text-center text-white pb-1 pb-lg-4">Compra Ganando</h1>
		...
		<div class="row">
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<h4>Acceso sin barreras 🚀</h4>

					<p>Empieza tu negocio sin inversión inicial, sin inventarios y sin complicaciones</p>
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<h4>Gana por consumir 💰</h4>

					<p>Genera ingresos con el consumo propio y el de tu red, sin necesidad de vender.</p>
			...
			<div class="col-12 col-lg-4 p-3 p-sm-4">
				...
				<div class="bg-white text-center py-5 px-4">
					...
					<p>Emprende a tu ritmo, sin sacrificar tu tiempo ni tu estilo de vida.</p>
